      ...
      <body className="bg-background text-foreground">
        ...
        >
          <main className="min-h-screen flex flex-col items-center ">
            <div className="flex-1 w-full flex flex-col gap-20 items-center dark:bg-rose-700">
              ...
              <div className="flex flex-col gap-20 max-w-5xl p-5 dark:bg-slate-800 rounded-xl">
                {children}
              </div>
            </div>
          </main>
